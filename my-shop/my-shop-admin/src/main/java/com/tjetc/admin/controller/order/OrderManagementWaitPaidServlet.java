...
@WebServlet(urlPatterns = {"/orderManagement/page2"})
public class OrderManagementWaitPaidServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AdminPageResult<OrderManagement> result = orderManagementService.waitPaid(start, pageSize);
