 ...
 */
    ...
    @WebServlet(urlPatterns = {"/orderManagement/page6"})
    public class OrderManagementReceivedOrderServlet extends HttpServlet {
        ...
        protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            AdminPageResult<OrderManagement> result = orderManagementService.ReceivedOrder(start, pageSize);
